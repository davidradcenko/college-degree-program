...
<body>
    <div class="main_div">
       ...
       <img class="text_conec11" src="img/addAnket/Group15.png" alt="">
        ...
        <p class="text_conec61"><a class="text_in_textcontnr6" href="index">Вернутся на главную</a></p>
          <img class="plagin_img" src="img/plagin/mdi_call_made.png" alt="">
            <img class="imgproger" src="img/imgesbygalter.jpg" alt="">
       ...
       <img class="img11" src="img/img6.png" alt="">
        ...
        <div id="id_main_div1">
          <p class="bloc_text1">Бухгалтер: плюсы и минусы профессии</p>
...
<!--                     <div class="kryg4"></div> -->
	...
	На протяжении последних лет профессия бухгалтера остается одной из самых востребованных на кадровом рынке. Бурное развитие экономики в нашей стране повлекло за собой расширение уже существующих компаний, рост количества их филиалов и отделений, а также возникновение новых фирм. По прогнозам аналитиков, интерес к представителям данной профессии со стороны работодателей не ослабеет и в перспективе.

	Работа бухгалтера вовсе не ограничивается миром активов, пассивов, проводок и балансов. Настоящий профессионал обязан ориентироваться во всем, что имеет отношение к деятельности организации, в которой он трудится, интересоваться экономикой, политикой, отслеживать изменения в законодательстве и постоянно повышать свою квалификацию.
                                                                        
                                       Функциональные обязанности

	К типичным обязанностям бухгалтера можно отнести:

	  • ведение бухгалтерского, налогового, управленческого учета – на одном или нескольких участках;
	  • составление учетной политики организации;
	  • взаимодействие с контролирующими организациями.

    Если речь идет об иностранной компании, то в обязанности бухгалтера также входит:

	  • ведение отчетности по международным стандартам;
	  • трансформация российской отчетности в западную;
	  • работа с информационными системами бухгалтерского учета на английском языке.

	Многое зависит от специфики конкретной организации. Самыми трудными считаются банковская, строительная и страховая сферы. 

	Успешно справляться с подобной операционной деятельностью можно при наличии внимательности, усидчивости, склонности к рутинной работе и умении грамотно планировать свое рабочее время.
                    
                                        Плюсы и минусы

	К плюсам профессии можно отнести стабильность работы. Хорошие бухгалтеры на рынке труда всегда востребованы, у них есть возможность непрерывно развиваться и подниматься вверх по карьерной лестнице. 

	Но и минусов у данной профессии тоже хватает. Зачастую у бухгалтеров бывает ненормированный рабочий день. Им необходимо постоянно осваивать большие объемы информации в связи с частыми изменениями законодательства. 

	Бухгалтер в компании – лицо материально ответственное, причем подотчетное не только руководителю отдела или предприятия. На всех фирмах периодически проводятся аудиторские проверки, регулярно приходится встречаться с представителями налоговых органов. Правильное отчисление налогов – один из самых важных элементов работы, ведь к нарушителям применяются серьезные санкции, вплоть до лишения свободы.
                    
                                        
                    </textarea>
                    
                      <iframe class="video_byx" width="460" height="215" src="https://www.youtube.com/embed/fOe6TdTXL2U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>   
