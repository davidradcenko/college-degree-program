...
<p class="text_foto1">Был в сети ${userInfoPageContext.getLotstime()}</p>
...
<p class="text_foto4"> ${userInfoPageContext.getVk()}</p>
<p class="text_foto5">${userInfoPageContext.getInst()}</p>
...
<!--                                         <p class="text22">На главную</p>-->
             <p class="text3">Выйти</p>
              <img  class="imgSautchPlagen1" src="img/mainUser/HomePlagen.png" alt="">
               <img id="ytu1"  class="imgSautchPlagen2" src="" alt="">
            <img id="ytu2"  class="imgSautchPlagen22" src="" alt="">
          ...
          <p id="but2" class="text_in_navi2">Конкурс</p>
